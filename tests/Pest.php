...
| using the "uses()" function to bind a different class or trait.
*/
...
| Functions
|--------------------------------------------------------------------------
| While Pest is very powerful out-of-the-box, you may have test suites
| that require some extra work to get started. Here we provide some
| helper functions that you can use to simplify the test writing process.
*/
